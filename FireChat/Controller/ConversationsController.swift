...
class ConversationsController: UIViewController {
    ...
    func presentChatController(forUser chatPartner: User) {
        let controller = ChatController(chatPartner: chatPartner)
...
extension ConversationsController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let chatPartner = conversations[indexPath.row].chatPartner
        presentChatController(forUser: chatPartner)
    }
}
